...
#include "button.h"
int keyReg0[3] = {NORMAL_STATE, NORMAL_STATE, NORMAL_STATE};// trang thai truoc truoc do
int keyReg1[3] = {NORMAL_STATE, NORMAL_STATE, NORMAL_STATE};//trang thai truoc do
int keyReg2[3] = {NORMAL_STATE, NORMAL_STATE, NORMAL_STATE};//trang thai hien tai

int keyReg3[3] = {NORMAL_STATE, NORMAL_STATE, NORMAL_STATE};// trạng thái ổn định trước ddos ̣neu co
